...
(function() {
  ...
  DocPad = (function(_super) {
    ...
    DocPad.prototype.events = ['extendTemplateData', 'extendCollections', 'docpadLoaded', 'docpadReady', 'docpadDestroy', 'consoleSetup', 'generateBefore', 'populateCollectionsBefore', 'populateCollections', 'generateAfter', 'contextualizeBefore', 'contextualizeAfter', 'renderBefore', 'renderCollectionBefore', 'render', 'renderDocument', 'renderCollectionAfter', 'renderAfter', 'writeBefore', 'writeAfter', 'serverBefore', 'serverExtend', 'serverAfter', 'notify'];
    ...
    */
    ...
    DocPad.prototype.ensureFileOrDocument = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return this.ensureModel.apply(this, args);
    };
    ...
    DocPad.prototype.ensureModel = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return this.createModel.apply(this, args);
    };
    ...
    DocPad.prototype.contextualizeFiles = function(opts, next) {
      var collection, config, docpad, locale, slowFilesObject, slowFilesTimer, templateData, _ref1;
      if (opts == null) {
        opts = {};
      }
      docpad = this;
      ...
      if ((_ref1 = opts.progress) != null) {
        _ref1.step("contextualizeFiles (preparing)").total(1).setTick(0);
      }
      ...
      docpad.emitSerial('contextualizeBefore', {
        ...
        tasks = new TaskGroup().setConfig({
          ...
          if ((_ref2 = opts.progress) != null) {
            _ref2.step("contextualizeFiles (postparing)").total(1).setTick(0);
          }
        ...
        if ((_ref2 = opts.progress) != null) {
          _ref2.step('contextualizeFiles').total(collection.length).setTick(0);
        }
    ...
    DocPad.prototype.renderFiles = function(opts, next) {
      var collection, config, docpad, locale, renderCollection, renderFile, renderPasses, slowFilesObject, slowFilesTimer, templateData, _ref1,
        _this = this;
      if (opts == null) {
        opts = {};
      }
      ...
      slowFilesTimer = null;
      if ((_ref1 = opts.progress) != null) {
        _ref1.step("renderFiles (preparing)").total(1).setTick(0);
      }
      ...
      renderCollection = function(collectionToRender, _arg, next) {
        ...
        return docpad.emitSerial('renderCollectionBefore', {
          ...
          if ((_ref2 = opts.progress) != null) {
            _ref2.step("renderFiles (pass " + renderPass + ")").total(collectionToRender.length).setTick(0);
          }
      ...
      docpad.emitSerial('renderBefore', {
        ...
        tasks = new TaskGroup().once('complete', function(err) {
          ...
          if ((_ref2 = opts.progress) != null) {
            _ref2.step("renderFiles (postparing)").total(1).setTick(0);
          }
    ...
    DocPad.prototype.writeFiles = function(opts, next) {
      ...
      slowFilesTimer = null;
      if ((_ref1 = opts.progress) != null) {
        _ref1.step("writeFiles (preparing)").total(1).setTick(0);
      }
      ...
      docpad.emitSerial('writeBefore', {
        ...
        tasks = new TaskGroup().setConfig({
          ...
          if ((_ref2 = opts.progress) != null) {
            _ref2.step("writeFiles (postparing)").total(1).setTick(0);
          }
        ...
        if ((_ref2 = opts.progress) != null) {
          _ref2.step('writeFiles').total(collection.length).setTick(0);
        }
        collection.forEach(function(file, index) {
          return tasks.addTask(function(complete) {
            var fileTasks;
    ...
    DocPad.prototype.generate = function(opts, next) {
      ...
      if (opts.initial == null) {
        opts.initial = (lastGenerateStarted != null) === false;
      }
      if (opts.reset == null) {
      ...
      tasks = new TaskGroup().on('item.run', function(item) {
        var totals, _ref3;
        ...
        var howMany, seconds, _ref3, _ref4;
      ...
      addGroup('Determine files to render', function(addGroup, addTask) {
        if (opts.partial === false) {
          ...
          return addTask('Add only changed models to render queue', function() {
            return opts.collection != null ? opts.collection : opts.collection = new FilesCollection().add(docpad.getCollection('generate').findAll({
              $or: {
                mtime: {
      ...
      addGroup('Process Files', function(addGroup, addTask) {
    ...
    DocPad.prototype.clean = function(opts, next) {
      ...
      tasks.addTask('resetCollections', function(complete) {
        return docpad.resetCollections(opts, complete);
      });
    ...
    DocPad.prototype.serveDocument = function(opts, next) {
      var collection, content, contentType, docpad, document, dynamic, err, req, res, templateData, _ref1;
      _ref1 = extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
    ...
    DocPad.prototype.server = function(opts, next) {
      var config, docpad, express, http, locale, port, servers, tasks, _ref1, _ref2, _ref3, _ref4;
      _ref1 = extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
      docpad = this;
      config = this.config;
      locale = this.getLocale();
      ...
      tasks.addTask(function(complete) {
        ...
        return opts.serverHttp.listen(port, function() {
