  ...
  DocumentModel = (function(_super) {
    ...
    DocumentModel.prototype.parse = function(opts, next) {
      ...
      DocumentModel.__super__.parse.call(this, opts, function() {
        var body, content, err, header, key, match, meta, metaDataChanges, metaParseResult, parser, regex, seperator, _i, _j, _len, _len1, _ref2, _ref3, _ref4, _ref5;
        meta = _this.getMeta();
        metaDataChanges = {};
    ...
    DocumentModel.prototype.renderExtensions = function(opts, next) {
      var content, extension, extensions, extensionsReversed, file, filePath, filename, renderSingleExtensions, result, tasks, templateData, _i, _len, _ref1;
      file = this;
      _ref1 = extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
    ...
    DocumentModel.prototype.render = function(opts, next) {
      var contentRenderedWithoutLayouts, file, key, relativePath, tasks, value, _base, _base1, _ref1, _ref2;
      if (opts == null) {
        opts = {};
      }
      _ref1 = extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
    ...
    DocumentModel.prototype.writeSource = function(opts, next) {
      var body, content, file, header, metaData, parser, seperator, source, _ref1;
      _ref1 = extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
      file = this;
      if (opts.content == null) {
        opts.content = (this.getContent() || '').toString('');
      }
      if (opts.cleanAttributes == null) {
      ...
      if (opts.cleanAttributes === true || metaData.writeSource === 'once') {
